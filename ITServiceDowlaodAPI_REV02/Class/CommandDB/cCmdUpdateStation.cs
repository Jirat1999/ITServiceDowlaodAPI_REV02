...
namespace ITServiceDowlaodAPI_REV02.Class.CommandDB
{
    ...
    {
        public static bool C_PRCbUpdateStation(string ptCode, string ptName)
        {
            ...
            try
            {
                ...
                oSql.AppendLine($"UPDATE {cmlTable.tTCNM_MASTER_Stations} ");
                oSql.AppendLine($"SET FTName = N'{tSafeName}', FDUpdatedAt = GETDATE() ");
                oSql.AppendLine($"WHERE FTCode = '{ptCode}';");
